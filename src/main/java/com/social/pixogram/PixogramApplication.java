...
public class PixogramApplication implements CommandLineRunner {
	...
	ApplicationRunner init(UserRepository userRepo) {
		return args -> {
			Stream.of(new User("karupu", "karupu@gmail.com", "karupu"), new User("naveen", "naveen@gmail.com", "karupu"),
					new User("tamil", "tamil@gmail.com", "karupu"), new User("babu", "babu@gmail.com", "karupu"),
					new User("mani", "mani@gmail.com", "karupu"), new User("user", "user@gmail.com", "karupu"),
					new User("mohith", "mohith@gmail.com", "karupu"), new User("vijay", "vijay@gmail.com", "karupu"),
					new User("kutty", "kutty@gmail.com", "karupu"), new User("micky", "micky@gmail.com", "karupu"))
					.forEach(user -> {
						userRepo.save(user);
					});
